...
function getData(){
    ...
    success    : function(response) {
      ...
      $('.tabs').append(tabs);
      $('.right_side_content').append(slides);
       //end info
...
function widthInfo(){
    ...
    $('.wrap').css('width',win_width - 40);
};

function heightPage(){
  var win_height = $(window).height();
  $('.wrap').css('height',win_height - 40);
  //console.log(win_height)
  $('.swiper-slide').css('height',win_height - 123);
...
function info() {
    ...
    $('.tabs a').live('click', function (event){
        ...
        var dataTT = $(this).html();
        var clear = '';
        localStorage.setItem('dta', clear);
        localStorage.setItem('dta', dataA);
        localStorage.setItem('dtaT', dataTT);
        $.mobile.changePage('#info_page');
    })
};
//--------------------------------
